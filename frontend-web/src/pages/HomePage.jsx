    ...
    <div className="flex flex-col min-h-screen">
      ...
      <nav className="flex items-center justify-between px-6 py-4 bg-white shadow-sm">
        ...
        <div className="flex space-x-6">
          <Link to="/pricing" className="text-gray-900 hover:text-indigo-400 font-poppins">Pricing</Link>
          <Link to="/system" className="text-gray-900 hover:text-indigo-400 font-poppins">System</Link>
          <Link to="/how-it-works" className="text-gray-900 hover:text-indigo-400 font-poppins">How it Works</Link>
          <Link to="/destinations" className="text-gray-900 hover:text-indigo-400 font-poppins">Destinations</Link>
        </div>
